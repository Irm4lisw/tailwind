  ...
  return (
    <div className="">
      <div className="navbar bg-base-100">
        <div className=" navbar-start bg-neutral text-neutral-content">
        ...
        <div className="navbar-center bg-neutral text-neutral-content">
          <button className="btn btn-ghost text-xl">Hello Everyone</button>
        </div>
        <div className="navbar-end bg-neutral text-neutral-content">
